...
![docker shared drives setting](images/docker-shared-drives.png)
...
4. (Optional) Run an ngnix container and map a local folder with an index html file so that browsing to the site displays your html file

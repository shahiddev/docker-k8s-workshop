...
> Note: The ability to create deployments using this command is deprecated and will be removed soon so you may see a warning message to that effect. For the purpose of this example we can use it for now and safely ignore the warning.
